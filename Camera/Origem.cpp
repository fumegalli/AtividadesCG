...
const string objFile = "./textures/Suzanne/SuzanneTriTextured.obj";
const string mtlFile = "./textures/Suzanne/SuzanneTriTextured.mtl";
...
{
	glfwInit();
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Camera -- Rafael!", nullptr, nullptr);
